...
# Create Regions
@named Str = NeuralMass_Logistic(τ=0.0022, H=20, λ=300, r=0.3)
@named GPe = NeuralMass_Logistic(τ=0.04, H=20, λ=400, r=0.1)
@named STN = NeuralMass_Logistic(τ=0.01, H=20, λ=500, r=0.1)
@named GPi = NeuralMass_Logistic(τ=0.014, H=20, λ=400, r=0.1)
@named Th  = NeuralMass_Logistic(τ=0.002, H=10, λ=20, r=5)
@named EI  = NeuralMass_Logistic(τ=0.01, H=20, λ=5, r=5)
@named PY  = NeuralMass_Logistic(τ=0.001, H=20, λ=5, r=0.15)
@named II  = NeuralMass_Logistic(τ=2.0, H=60, λ=5, r=5)
