...
@testset "RL test" begin
    ...
    @named VAC = Cortical(N_wta=3, N_exci=3, namespace=global_ns, density=0.1, weight=1)
    @named PFC = Cortical(N_wta=2, N_exci=3, namespace=global_ns, density=0.1, weight=1)
