...
"""
mutable struct NGNMM_theta <: AbstractNeuralMass
    Cₑ::Num
    Cᵢ::Num
    connector::Num
    system::ODESystem
    namespace
    function NGNMM_theta(;name,namespace=nothing, Cₑ=30.0,Cᵢ=30.0, Δₑ=0.5, Δᵢ=0.5, η_0ₑ=10.0, η_0ᵢ=0.0, v_synₑₑ=10.0, v_synₑᵢ=-10.0, v_synᵢₑ=10.0, v_synᵢᵢ=-10.0, alpha_invₑₑ=10.0, alpha_invₑᵢ=0.8, alpha_invᵢₑ=10.0, alpha_invᵢᵢ=0.8, kₑₑ=0.0, kₑᵢ=0.5, kᵢₑ=0.65, kᵢᵢ=0.0)
        ...
        sts    = @variables aₑ(t)=-0.6 [output=true] bₑ(t)=0.18 aᵢ(t)=0.02 bᵢ(t)=0.21 gₑₑ(t)=0 gₑᵢ(t)=0.23 gᵢₑ(t)=0.26 gᵢᵢ(t)=0.0
...
NextGenerationEI(; kwargs...) = NGNMM_theta(; kwargs...)
