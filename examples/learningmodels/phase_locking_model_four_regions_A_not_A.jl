...
begin
	tmin = 0.0
	dt = 0.001
	tmax = length(phi_p1)*dt#length(phi_s1)*dt
	T = tmin:dt:tmax
end
...
begin
	...
	p_ce11 = plot(control_error_s1_p1[1:length(controller_call_times)-1], label="e(S1->P1)", linecolor = "red", lw=2.0, fg_legend = :false, legend = :outertop, tickfontsize=10,ytickfontsize=10, xguidefontsize=10, yguidefontsize=10,legendfontsize=9, xlabel = "Controller Call #", ylabel="e(t)", xlims=(0,5100), ylims=(-3.14,3.14))
	p_ce11 = plot!(control_error_p1_s1[1:length(controller_call_times)-1], label="e(P1->S1)", linecolor ="black", lw=:2.0, fg_legend = :false, legend = :outertop, tickfontsize=10,ytickfontsize=10, xguidefontsize=10, yguidefontsize=10,legendfontsize=9, xlabel = "Controller Call #", ylabel="e(t)", xlims=(0,5100), grid = false, ylims=(-3.14,3.14), xticks = 0:750:4500, titlefontsize=11)
	title!("Control Error (S1<->P1)")

	p_cumul11 = plot(cumulative_error_all_11[1:length(controller_call_times)-1], linecolor ="purple", lw=:2.0, fg_legend = :false, legend = :outertop, tickfontsize=10,ytickfontsize=10, xguidefontsize=10, yguidefontsize=10,legendfontsize=9, xlabel = "Controller Call #", ylabel="cumule(t)", xlims=(0,5100), grid = false, xticks = 0:750:4500, titlefontsize=11, label=false)
...
begin
	...
	p_lfp_late11 = plot!(T, x_p1, xlabel= "Time (s)", label="Prefrontal Cortex", lw=1.8, lc=:black, xlims=(725,726.1), fg_legend = :false, legend = :outertop, xtickfontsize=10,ytickfontsize=10, xguidefontsize=10, yguidefontsize=10,legendfontsize=9, grid = false, titlefontsize=11, xticks = 725:0.5:726, ylabel="arb. V")
	...
	p_lfp_late22 = plot!(T, x_p2, xlabel= "Time (s)", label="Prefrontal Cortex", lw=1.8, lc=:black, xlims=(725,726.1), fg_legend = :false, legend = :outertop, xtickfontsize=10,ytickfontsize=10, xguidefontsize=10, yguidefontsize=10,legendfontsize=9, grid = false, titlefontsize=11, xticks = 725:0.5:726, ylabel="arb. V")
...
begin
	...
	bb = plot(T, g_p2s2, label="g(P1->S1)", lw=2.3, lc=:black, fg_legend = :false, legend = :bottomleft, xtickfontsize=10,ytickfontsize=10, xguidefontsize=10, yguidefontsize=10,legendfontsize=9, xlims=(0, tmax-1), grid = false, xticks = 0:75:725, titlefontsize=11,ylims=(-5,50))
	bb = plot!(T, g_s2p2, label="g(S2->P2)", lw=2.5, lc=:red, fg_legend = :false, legend = :topleft, xtickfontsize=10,ytickfontsize=10, xguidefontsize=10, yguidefontsize=10,legendfontsize=9, ylims=(-5,50))
...
begin
plot(T, (g_s1p1 .+ g_p1s1)/2, lw=5.8, lc=:purple, fg_legend=:false, label="Category A (S1 <-> P1)")
plot!(T, (g_s2p2 .+ g_p2s2)/2, lw=5.8, lc=:gold, fg_legend=:false, label="Category B (S2 <-> P2)", xlims=(0, tmax-1), grid = false, xticks = 0:75:725, ylims=(-5,50), legend = :topleft, ylabel="Edge Weight Average", xlabel="Time (s)", title="Learning Weights", xtickfontsize=14,ytickfontsize=14, xguidefontsize=14, yguidefontsize=14,legendfontsize=14,titlefontsize=19)
end
